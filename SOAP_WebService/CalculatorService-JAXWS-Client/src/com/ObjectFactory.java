...
public class ObjectFactory {
    ...
    private final static QName _AddResponse_QNAME = new QName("http://com/", "addResponse");
    private final static QName _MulResponse_QNAME = new QName("http://com/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://com/", "subResponse");
    private final static QName _DivResponse_QNAME = new QName("http://com/", "divResponse");
    private final static QName _Div_QNAME = new QName("http://com/", "div");
    private final static QName _Add_QNAME = new QName("http://com/", "add");
    private final static QName _Mul_QNAME = new QName("http://com/", "mul");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "mul")
