...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/CalculatorService/services/Calculator";
    ...
    public com.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.CalculatorSoapBindingStub _stub = new com.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.CalculatorSoapBindingStub _stub = new com.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com", "Calculator"));
        }
